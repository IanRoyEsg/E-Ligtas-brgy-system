<template>
 ...
 <figure class="pageLogo">
            <img :src="'/storage/images/report-ic.svg'" class="pageLogo__image" style="height:60px; margin-left:650px; margin-top: 20px;" alt="e-Ligtas Project">
        </figure>



        <div class="py-6 mt-16" style=" width: 1150px; margin-left:110px; margin-top: -5px;">
                     ...
                     <table class="table-fixed w-full bg-blue-200">
                        <thead class="flex w-full bg-blue-200">
                            <tr class="flex w-full mb-4 ">
                                ...
                                <th class="px-6 py-2 w-1/4 border-b-2 border-blue-200 bg-blue-300 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Report Title</th>
                                <th class="px-6 py-2 w-1/2 border-b-2 border-blue-200 bg-blue-300 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Report Information</th>
                    ...
                    <div class="myBox">
                        <tbody class="bg-blue-200 flex flex-col items-center justify-between w-full" style="height: 50vh;">
                            <tr v-for="(row, index) in data" :key="index" class="flex w-full mb-4">
                                ...
                                <td class="px-6 py-1 w-1/2 border-b border-blue-200 bg-blue-200 text-sm flex flex-no-wrap overflow-x-scroll scrolling-touch justify-center">{{ row.body }}</td>
                                <td class="px-6 py-1 w-1/4 border-b border-blue-200 bg-blue-200 text-sm">
                                    ...
                                    <button @click="deleteRow(row)"  class="ml-3 text-red-600 hover:text-red-900">Delete</button>
                                </td>
                            </tr>
                      ...
                      <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                        ...
                        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
                          ...
                          <div class="bg-blue-200 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            <span class="text-lg font-bold flex justify-center mb-3 text-gray-700" style=" letter-spacing: 0.05em;">Report</span>
                            <div class="">
                                  <div class="mb-4">
                                  ...
                                  <div class="mb-4">
                                      <label for="exampleFormControlInput2" class="block text-gray-700 text-sm font-bold mb-2">Information:</label>
                                      <textarea class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="exampleFormControlInput2" style="height:150px" v-model="form.body" placeholder="Enter Information"></textarea>
