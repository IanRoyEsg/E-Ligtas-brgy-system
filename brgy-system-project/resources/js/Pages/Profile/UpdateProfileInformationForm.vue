    ...
    <jet-form-section @submitted="updateProfileInformation" >
        ...
        <template #form>
            ...
            <div class="col-span-6 sm:col-span-4" v-if="$page.props.jetstream.managesProfilePhotos">
                ...
                <jet-label for="photo" value="Profile Photo" />

                <!-- Current Profile Photo -->
                <div class="mt-2" v-show="! photoPreview">
                    <img :src="user.profile_photo_url" :alt="user.firstname" class="rounded-lg h-20 w-20 object-cover">
                </div>
                ...
                <jet-secondary-button class="mt-2 mr-2" type="button" @click.prevent="selectNewPhoto" style="color: white; height:25px; background-color: rgb(55, 65, 81);">
                    Select A New Photo
                </jet-secondary-button>

                <jet-secondary-button type="button" class="mt-2" @click.prevent="deletePhoto" v-if="user.profile_photo_path" style="color: white; height:25px; background-color: rgb(55, 65, 81);">
                    Remove Photo
                </jet-secondary-button>
