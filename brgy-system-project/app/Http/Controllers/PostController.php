...
class PostController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('posts.index')->with('success', 'Post was successfully created');
    }
    ...
    public function update(Request $request, Post $post)
    {
        ...
        return redirect()->route('posts.index')->with('success', 'Post was successfully edited.');
    }
    ...
    public function destroy(Post $post)
    {
        ...
        return back()->with('success', 'Post was successfully deleted');
    }
}
